...
//
//import org.avxxx.CameraEnumerationAndroid.CaptureFormat;
//
...
//                Log.d(TAG, "VideoCapturerAndroid stacks trace:");
...
//        }
//        Log.d(TAG, "VideoCapturerAndroid isCapturingToTexture : " + isCapturingToTexture);
//    }
//
...
//        Log.d(TAG, "lookupDeviceName: " + deviceName);
...
//        checkIsOnCameraThread();
//        if (camera == null) {
//            Log.e(TAG, "Calling onOutputFormatRequest() on stopped camera.");
//            return;
//        }

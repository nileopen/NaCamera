...
@TargetApi(11)
public class GPUImageNaRenderer implements Renderer, INaSurfaceHelper {
    ...
    public GPUImageNaRenderer(final GPUImageFilter filter) {
        mFilter = filter;
...
//                @Override
//                public void run() {
//                    JniCommonUtil.getInstance().YUVtoRBGA(data, previewSize.width, previewSize.height,
//                            mGLRgbBuffer.array());
...
//                    camera.setPreviewCallback(GPUImageNaRenderer.this);
//                    camera.startPreview();
//                    NaCameraEngineManager.getInstance().openCamera();
//                } catch (IOException e) {
//                    e.printStackTrace();
//                }
            }
